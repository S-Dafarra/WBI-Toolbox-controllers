function [f,COM_des,exitflag,COMref,chi] = solve_mpc2(m, Cl, Bl, Cr, Br, ch_points, Alr, omega, g, f_prev, COMx,COMv,COMdes, ICPoffset, minZ, gains, gamma0, nsteps, dT, k_impact)
...
[hessian,gradient,~,~,Ceq,Beq,Cleq,Bleq,fRH] = cost_constraints2(m, Cl, Bl, Cr, Br, ch_points, Alr, omega, g, ref, gains, gamma0, nsteps, dT, k_impact);
